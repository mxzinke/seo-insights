...
2. Run `/seo-keywords` to cross-reference with your GSC data — this shows which of these topics you already (partially) rank for, and where the biggest opportunity gaps are.
